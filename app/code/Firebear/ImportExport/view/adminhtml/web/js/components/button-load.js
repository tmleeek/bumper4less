        ...
        return Element.extend(button).extend(
            {
                ...
                addChilds: function () {
                    this.error('');
                    var maps = jQuery.parseJSON(localStorage.getItem('map'));
                    var columns = jQuery.parseJSON(localStorage.getItem('columns'));
                    var options = jQuery.parseJSON(localStorage.getItem('options'));
                    var linked = {};
                    var nothings = [];
                    var self = this;
