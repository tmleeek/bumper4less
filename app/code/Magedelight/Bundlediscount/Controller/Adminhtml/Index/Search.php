...
class Search extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $block = $resultPage->getLayout()->getBlock('product_search');
        $block->setIndex($this->getRequest()->getParam('index'));

        $sub_block = $resultPage->getLayout()->getBlock('product_search_grid');
        $sub_block->setIndex($this->getRequest()->getParam('index'));
