...
class Mdfrd implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        if ($_SERVER['SERVER_NAME'] != 'localhost' && $_SERVER['SERVER_ADDR'] != '127.0.0.1') {
            $keys['serial_key'] = $this->_scopeConfig->getValue('bundlediscount/license/serial_key', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
            $keys['activation_key'] = $this->_scopeConfig->getValue('bundlediscount/license/activation_key', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
