    ...
    $.widget('mage.SwatchRenderer', {
        ...
        _LoadProductMedia: function () {
            ...
            if ($('body.catalog-product-view').size() > 0) {
                //Product Page
                if($($this.context).hasClass('customSwachslider')) {
                    productId = $($this.context).attr('data-product-id-swatch');
                } else {
                    productId = $this.parents('.product-info-main')
        ...
        _EnableProductMediaLoader: function ($this) {
            ...
            if ($('body.catalog-product-view').size() > 0) {
                if($($this.context).hasClass('customSwachslider')) {
                    $($this.context).parents('.product-item-info').find('.product-image-photo')
        ...
        updateBaseImage: function (images, context, isProductViewExist) {
            var justAnImage = images[0],
                ...
                item;
            if($(context.context).hasClass('customSwachslider')){
                if (justAnImage && justAnImage.img) {
                    $(context.context).parents('.product-item-info').find('.product-image-photo').attr('src', justAnImage.img);
                }
            } else {
                if (isProductViewExist) {
