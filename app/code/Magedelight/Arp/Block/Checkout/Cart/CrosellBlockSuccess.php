...
class CrosellBlockSuccess extends \Magento\Catalog\Block\Product\ListProduct
{   
    ...
    public function getProductBlockCrossell() {
        ...
        $relatedProductsblock = $this->collectionFactory->create()
                ...
                'eq' => \Magedelight\Arp\Model\Source\BlockPage::ORDER_SUCCESS_PAGE
                ])
    ...
    public function getPageTopEnabled() {
        return $this->arpHelper->getConfig('arp_products/ordersuccesspage/enabled');
    }
    ...
    {   
        if(!empty($this->getProductBlockCrossell())) {
            if($this->getProductBlockCrossell()['display_cart_button'] == 0) {
                return $this->arpHelper->getConfig('arp_products/ordersuccesspage/addtocartbutton');
            } else {
    ...
    public function getMaxProductsDisplay() 
    {
        if(!empty($this->getProductBlockCrossell())) {
            if($this->getProductBlockCrossell()['max_products_display'] == 0) {
                ...
                return $this->arpHelper->getConfig('arp_products/ordersuccesspage/displaymaxproduct_grid');
                } else {
               return $this->arpHelper->getConfig('arp_products/ordersuccesspage/displaymaxproduct_slider');
               } 
            } else {
    ...
    public function getNumberOfRows() 
    {
        if(!empty($this->getProductBlockCrossell())) {
            if($this->getProductBlockCrossell()['number_of_rows'] == 0) {
                return $this->arpHelper->getConfig('arp_products/ordersuccesspage/noOfColunm');
            } else {
    ...
    public function getBlockLayout() 
    {
        if(!empty($this->getProductBlockCrossell())) {
            if($this->getProductBlockCrossell()['block_layout'] == 0) {
                return $this->arpHelper->getConfig('arp_products/ordersuccesspage/block_layout');
            } else {
    ...
    public function getSlidesToShow() {
        if(!empty($this->getProductBlockCrossell())) {
            if($this->getProductBlockCrossell()['slides_to_show'] == 0) {
                return $this->arpHelper->getConfig('arp_products/ordersuccesspage/slidesToShow');
            } else {
    ...
    public function getSlidesToScroll() {
        if(!empty($this->getProductBlockCrossell())) {
            if($this->getProductBlockCrossell()['slides_to_scroll'] == 0) {
                return $this->arpHelper->getConfig('arp_products/ordersuccesspage/slidesToScroll');
            } else {
    ...
    public function isShowQuickView() {
        return $this->arpHelper->getConfig('arp_products/ordersuccesspage/quickview');
    }
