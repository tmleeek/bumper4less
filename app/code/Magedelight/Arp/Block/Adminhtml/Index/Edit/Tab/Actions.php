    ...
    \Magento\Ui\Component\Layout\Tabs\TabInterface
{
     ...
     */
    protected function addTabToForm($model, $fieldsetId = 'actions_fieldset', $formName = 'arp_form')
    {
        if (!$model) {
        ...
        $actionsFieldSetId = $this->getActionsFieldSetId($formName);

        $newChildUrl = $this->getUrl(
            'advancerelated/index/newActionHtml/form/' . $actionsFieldSetId,
            ['form_namespace' => $formName]
        );
            $model->getConditions()
            ->setJsFormObject('viewed_conditions_fieldset');
        ...
        $customField = $fieldset->addField('productactions',
            'text',
            [   
                'name' => 'productactions',
        ...
        $renderer = $this->getLayout()->createBlock('Magedelight\Arp\Block\Adminhtml\Index\Form\Renderer\ActionsButton');
    ...
    {
        return $formName . '_rule_actions_fieldset_' . $this->getId();
    }
}
