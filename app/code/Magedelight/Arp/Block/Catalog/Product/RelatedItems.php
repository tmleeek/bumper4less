...
class RelatedItems extends \Magento\Catalog\Block\Product\ProductList\Related
{   
    ...
    public function getProductBlockRelated() {
        ...
        $relatedProductsblock = $this->collectionFactory->create()
                ...
                ->setPageSize(1);
                //echo $relatedProductsblock->getSelect()->__ToString();
    ...
    {   
        if(!empty($this->getProductBlockRelated())) {
            if($this->getProductBlockRelated()['display_cart_button'] == 0) {
                return $this->arpHelper->getConfig('arp_products/productpage/'.$this->getGroupName().'/addtocartbutton');
            } else {
    ...
    public function getMaxProductsDisplay() 
    {
        if(!empty($this->getProductBlockRelated())) {
            if($this->getProductBlockRelated()['max_products_display'] == 0) {
                ...
                return $this->arpHelper->getConfig('arp_products/productpage/'.$this->getGroupName().'/displaymaxproduct_grid');
                } else {
               return $this->arpHelper->getConfig('arp_products/productpage/'.$this->getGroupName().'/displaymaxproduct_slider');
               } 
            } else {
    ...
    public function getNumberOfRows() 
    {
        if(!empty($this->getProductBlockRelated())) {
            if($this->getProductBlockRelated()['number_of_rows'] == 0) {
                return $this->arpHelper->getConfig('arp_products/productpage/'.$this->getGroupName().'/noOfColunm');
            } else {
    ...
    public function getBlockLayout() 
    {
        if(!empty($this->getProductBlockRelated())) {
            if($this->getProductBlockRelated()['block_layout'] == 0) {
                return $this->arpHelper->getConfig('arp_products/productpage/'.$this->getGroupName().'/block_layout');
            } else {
    ...
    public function getPageTopEnabled() {
        return $this->arpHelper->getConfig('arp_products/productpage/'.$this->getGroupName().'/enabled');
    }
    
    public function getSlidesToShow() {
        if(!empty($this->getProductBlockRelated())) {
            if($this->getProductBlockRelated()['slides_to_show'] == 0) {
                return $this->arpHelper->getConfig('arp_products/productpage/'.$this->getGroupName().'/slidesToShow');
            } else {
    ...
    public function getSlidesToScroll() {
        if(!empty($this->getProductBlockRelated())) {
            if($this->getProductBlockRelated()['slides_to_scroll'] == 0) {
                return $this->arpHelper->getConfig('arp_products/productpage/'.$this->getGroupName().'/slidesToScroll');
            } else {
