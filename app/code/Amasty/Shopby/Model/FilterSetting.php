...
use Amasty\Shopby\Model\ResourceModel\GroupAttr as ResourceGroupAttr;
...
class FilterSetting extends \Magento\Framework\Model\AbstractModel implements FilterSettingInterface, IdentityInterface
{
    ...
    /**
     * @var ResourceGroupAttr\CollectionFactory
     */
     ...
     * @param ResourceGroupAttr\CollectionFactory $collectionFactory
    ...
    public function __construct(
        ...
        ResourceGroupAttr\CollectionFactory $collectionFactory,
    ...
    {
        $this->_init(\Amasty\Shopby\Model\ResourceModel\FilterSetting::class);
    }
    ...
    {
        $size = 0;
        if ($this->getAttributeModel() && !$this->hasGroupCollection()) {
            $code = $this->getAttributeModel()->getId();
            $collection = $this->collectionFactory->create()
                ->addFieldToFilter('attribute_id', $code)
