...
abstract class Options extends \Magento\Backend\App\Action
{
    public function applyToProduct($productId, $objectToStore) {
        //function moved to helper
        return $this->_objectManager->get('Itoris\DynamicProductOptions\Helper\Data')->applyToProduct($productId, $objectToStore);
    }
}