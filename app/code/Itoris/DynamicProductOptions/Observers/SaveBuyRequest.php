...
class SaveBuyRequest implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer) {
        if ($this->isEnabledFlag) {
            $this->_objectManager->get('Magento\Backend\Model\Session')->setDynamicOptionsBuyRequest($this->_request->getParams());
        }
    }
}